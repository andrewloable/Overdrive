...
Java_com_loabletech_bladewatch_camera_HardwareBufferTextureBinder_probeExtensionsNative(
...
Java_com_loabletech_bladewatch_camera_HardwareBufferTextureBinder_bindHardwareBufferToTextureNative(
