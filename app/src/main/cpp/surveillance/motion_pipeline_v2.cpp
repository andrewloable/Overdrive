...
Java_net_bladewatch_app_surveillance_NativeMotion_initPipelineV2(
...
extern "C" JNIEXPORT void JNICALL
Java_net_bladewatch_app_surveillance_NativeMotion_processFrameV2(
    JNIEnv* env, jclass clazz,
    jobject frameBuffer,
...
Java_net_bladewatch_app_surveillance_NativeMotion_getPipelineConfigSize(
    JNIEnv* env, jclass clazz)
{
...
extern "C" JNIEXPORT jint JNICALL
Java_net_bladewatch_app_surveillance_NativeMotion_getQuadrantResultSize(
    JNIEnv* env, jclass clazz)
{
...
extern "C" JNIEXPORT void JNICALL
Java_net_bladewatch_app_surveillance_NativeMotion_initTracker(
    JNIEnv* env, jclass clazz)
{
...
extern "C" JNIEXPORT jint JNICALL
Java_net_bladewatch_app_surveillance_NativeMotion_trackerStartTrack(
    JNIEnv* env, jclass clazz,
...
extern "C" JNIEXPORT void JNICALL
Java_net_bladewatch_app_surveillance_NativeMotion_trackerUpdate(
    JNIEnv* env, jclass clazz,
    jbyteArray frameRgb, jint width, jint height,
...
Java_net_bladewatch_app_surveillance_NativeMotion_trackerHasActiveTrack(
...
Java_net_bladewatch_app_surveillance_NativeMotion_trackerGetTrackBox(
    JNIEnv* env, jclass clazz, jint quadrant)
{
...
extern "C" JNIEXPORT void JNICALL
Java_net_bladewatch_app_surveillance_NativeMotion_trackerDropTrack(
    JNIEnv* env, jclass clazz, jint quadrant)
{
    if (!g_trackerInitialized) return;
...
extern "C" JNIEXPORT jboolean JNICALL
Java_net_bladewatch_app_surveillance_NativeMotion_trackerNeedsYoloHeartbeat(
    JNIEnv* env, jclass clazz, jint quadrant)
{
    if (!g_trackerInitialized) return JNI_FALSE;
...
extern "C" JNIEXPORT void JNICALL
Java_net_bladewatch_app_surveillance_NativeMotion_trackerConfirmHeartbeat(
...
extern "C" JNIEXPORT void JNICALL
Java_net_bladewatch_app_surveillance_NativeMotion_trackerRefreshTemplate(
    JNIEnv* env, jclass clazz,
    jbyteArray frameRgb, jint width, jint height,
    jint quadrant,
