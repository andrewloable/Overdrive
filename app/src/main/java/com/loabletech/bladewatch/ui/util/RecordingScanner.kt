...
object RecordingScanner {
    ...
    private const val LEGACY_BASE_DIR = "/storage/emulated/0/Android/data/net.bladewatch.app/files"
    ...
    fun getRecordingsDir(context: Context): File {
        return net.bladewatch.app.storage.StorageManager.getInstance().recordingsDir
    }
    ...
    fun getSentryEventsDir(context: Context): File {
        return net.bladewatch.app.storage.StorageManager.getInstance().surveillanceDir
    }
    ...
    fun getProximityEventsDir(context: Context): File {
        return net.bladewatch.app.storage.StorageManager.getInstance().proximityDir
    }
