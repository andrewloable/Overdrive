...
public class SentryDaemon {
    ...
    private static final int CONTROL_PORT = 19879;  // SentryDaemon control (19876=CameraDaemon, 19877=Surveillance IPC, 19878=BydEventDaemon)
    ...
    private static final String LOCATION_SERVICE_NAME = "net.bladewatch.app/.services.LocationSidecarService";
